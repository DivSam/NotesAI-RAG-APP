...
Based on the following context, generate 3 multiple choice questions and answers with 4 choices each and the correct answer always being the first choice.
----------------------
{context}
"""
